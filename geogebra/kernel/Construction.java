...
public class Construction {
	...
	final public TreeSet getGeoSetLabelOrder(int geoClassType) {
		TreeSet typeSet = (TreeSet) geoSetsTypeMap.get(new Integer(geoClassType));
		if (typeSet == null) {
	...
	private void addToGeoSets(GeoElement geo) {
		...
		TreeSet typeSet = (TreeSet) geoSetsTypeMap.get(new Integer(type));
		if (typeSet == null) {
	...
	private TreeSet createTypeSet(int type) {
		...
		geoSetsTypeMap.put(new Integer(type), typeSet);
		return typeSet;
	}
