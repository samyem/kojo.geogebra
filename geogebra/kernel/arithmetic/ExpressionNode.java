...
implements ExpressionValue {   
    ...
    final public ExpressionValue evaluate() {    	  
        ...
        case PLUS:                             
            ...
            /* doesn't work - see issue 174
            else if (lt instanceof GeoLine && rt instanceof GeoLine) {         
            	GeoLine line1 = (GeoLine)lt;
            	GeoLine line2 = (GeoLine)rt;               
            	return kernel.DependentLineAdd(line1, line2, this);
            }           */
        ...
        case MINUS:            
            ...
            /* doesn't work - see issue 174
            	...
            	return kernel.DependentLineSubtract(line1, line2, this);
            }           */
            /* doesn't work: f + g gives a free object
           else if (lt instanceof GeoFunction && rt instanceof GeoFunction) {  
        ...
        case MULTIPLY:            
            ...
            if (lt.isNumberValue()) {
                ...
                /*doesn't work - see issue 174
                // number * line
                else if (rt instanceof GeoLine) {         
                	GeoLine line1 = (GeoLine)rt;
                	NumberValue numb = (NumberValue)lt;
                	
                	return kernel.DependentLineMultiply(line1, numb, this);
                }           */
                else {                	
            ...
            /* doesn't work - see issue 174
            // line * number
            else if (lt instanceof GeoLine && rt.isNumberValue()) {         
            	GeoLine line1 = (GeoLine)lt;
            	NumberValue numb = (NumberValue)rt;
            ...
            if (rt.isNumberValue()) {
                //  number / number
                 ...
                 // line / number
                 	...
                 	return kernel.DependentLineDivide(line1, numb, this);
                 }           */
                else { 
...
//        		System.out.println("MULTIPLY: " + left + " (" + left.getClass() + "), right: " 
...
// display powers over 9 as unicode superscript
    ...
    final public static boolean isEqualString(ExpressionValue ev, double val, boolean symbolic) {
    	if (ev.isLeaf() && ev instanceof NumberValue) {
    		...
    		// keep function variables and special doubles (pi, degree, rad),
    		if (ev instanceof FunctionVariable || ev instanceof MySpecialDouble) 
    		{
    			return false;
    		}
